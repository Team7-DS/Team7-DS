...
st.markdown("<h2 style='text-align: center; color: blue;'>University of New Haven Course Recommendation System</h2>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: black;'>Find similar courses from a dataset of over 3,000 courses from University Courses</h4>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: black;'>TEAM 7</h4>", unsafe_allow_html=True)
...
if st.button('Show Recommended Videos or courses'):
    ...
    st.text(" ")
    st.markdown("<h6 style='text-align: center; color: red;'></h6>", unsafe_allow_html=True)
